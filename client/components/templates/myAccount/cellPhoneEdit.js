...
import OrganismCellPhoneEdit from '../../organisms/CellPhone/organismCellPhoneEdit';

class CellPhoneEdit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    let breadcrumbInfo = {
      label: staticLabels && staticLabels["pwa.breadcrum.editPhone.label"],
      breadcrumbData: [
        {
        ...
        {
          "navigationState": "/users/addPhone",
          "label": staticLabels && staticLabels["pwa.viewPhone.celulares.label"],
        }
      ],
      isMyAccount: true
              ...
              <div className="container o-container__secondary">
                ...
                <div className="row mt-lg-3 m-row-bootstrap">
                  <aside className="col-lg-3 pr-4 m-aside__content">
                    <Aside handleleftNavData={handleleftNavData} leftNavData={leftNavData} headingText={staticLabels && staticLabels["pwa.breadcrum.editPhone.label"]} />
                  </aside>
                  <OrganismCellPhoneEdit staticLabels={staticLabels} />
                </div>
              </div>
            </div>
