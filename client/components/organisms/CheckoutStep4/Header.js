/**
* Module Name : Header
* Functionality : Showing Header template
* @exports : Header
...
export default class extends React.Component {
    ...
    /**
     * Method will call to get header data.
     * @function getHeaderData
     * @author shreyansh.khare@zensar.com
     * @desc Making RESTful serivce call to fetch header info to show header data.
     * 
     */
    getHeaderData = async () => {
    
//console.log('headerData',this.props.checkoutHeaderData.headerContent[0].orderConfirmation[0])
if(this.props.checkoutHeaderData !== []){
      this.setState({
                    headerData:this.props && this.props.checkoutHeaderData && this.props.checkoutHeaderData.headerContent && this.props.checkoutHeaderData.headerContent[0] && this.props.checkoutHeaderData.headerContent[0].orderConfirmation && this.props.checkoutHeaderData.headerContent[0].orderConfirmation[0]?this.props.checkoutHeaderData.headerContent[0].orderConfirmation[0] :{}
                })
    }else {
    ...
    /**
     * REACT life cycle Event. This will get fire on component will load.
    ...
    /**
     * Method will return to home page.
     * @function redirectToHomePage
     * @author shreyansh.khare@zensar.com
     * @desc Method will return to home page
     * 
     */
    redirectToHomePage = () => {
   ...
   */
    ...
    render() {
        ...
        const { isDesktop, isIpad } = UserAgentDetails(this.props.window);
       ...
       paymentFlag = true;
        ...
        if (successData !== []) {
            for (var i = 0; i < successData.length; i++) {
                if (successData[i].itemType.toLocaleLowerCase() === "Digital".toLocaleLowerCase()) {
                    ...
                    }if(dataPath.cieWarningMessage){
                        setMessage = dataPath.cieWarningMessage + dataPath.userEmail;
                    }else{
                        setDigitalErrorMsgFlag = false;
                    }
                    //# end of 23837
        ...
        const headerContent = itemDetails && itemDetails.headerContentForPrint ? itemDetails.headerContentForPrint : {};
        ...
        let flag3DS = this.props.flag3DS;
            ...
            <React.Fragment>
                <div className="container-fluid -white">
                    ...
                    <div className="container p-0">
                        ...
                        {(itemDetails && itemDetails.success && itemDetails.success.length === 0 && !flag3DS) ?
                            ...
                            <div>
                                <div className="row align-items-center no-gutters justify-content-lg-between justify-content-center pt-lg-4 pb-lg-4 pt-3 pb-3 -checkoutHeaderConfirmation">
                                    <div className="col-lg-auto col-6 text-center">
                                        {staticLabels['pwa.orderConfirmation.headerDesktopLogo.Url'] !== undefined || staticLabels['pwa.orderConfirmation.headerMobileLogo.Url'] !== undefined ?
                                            <Image className="a-checkout__svgBag" src={isDesktop || isIpad ? staticLabels['pwa.orderConfirmation.headerDesktopLogo.Url'] : staticLabels['pwa.orderConfirmation.headerMobileLogo.Url']} onClick={this.redirectToHomePage} alt="Bag" />
                                            : null
                                        }
                                        ...
                                        <div className="row">
                                            <div className="col-auto">
                                                {(rightLink1 && rightLink1[0] && rightLink2 && rightLink2[0]) ?
                                                    <React.Fragment>
                                                        <ParagraphAnchor classParagraph="a-checkout__phoneText m-0" textParagraph={rightLink1[0].name} classAnchor="a-checkout__phoneID" href={!isDesktop && rightLink1[1].url} textAnchor={" "+rightLink1[1].text} />
                                                        <ParagraphAnchor classParagraph="a-checkout__phoneText m-0" textParagraph={rightLink2[0].name} classAnchor="a-checkout__phoneID" href={!isDesktop && rightLink2[1].url} textAnchor={" "+rightLink2[1].text} /> </React.Fragment> : null}
                                            </div>
                                            <div className="col-auto">
                                ...
                                <div className="row align-items-center justify-content-center pt-3 pb-5">
                                    <div className="col-lg-4 col-12 text-center">
                                        ...
                                        <Paragraph className="a-checkout__email">{rightLink1[0].name+" "+rightLink1[1].text+" / "+rightLink2[1].text}</Paragraph>
                            ...
                            <div>
                                    ...
                                    <div className="col-lg-auto col-6 d-none d-lg-flex">
                                        <div className="row">
                                            <div className="col-auto">
                                                {(rightLink1 && rightLink1[0] && rightLink2 && rightLink2[0]) ?
                                                    <React.Fragment>
                                                        <ParagraphAnchor classParagraph="a-checkout__phoneText m-0" textParagraph={rightLink1[0].name} classAnchor="a-checkout__phoneID" textAnchor={" "+rightLink1[1].text} />
                                                        <ParagraphAnchor classParagraph="a-checkout__phoneText m-0" textParagraph={rightLink2[0].name} classAnchor="a-checkout__phoneID" textAnchor={" "+rightLink2[1].text} /> </React.Fragment> : null}
                                            </div>
                                              <div className="col-auto">
                                            {rightLink3 && rightLink3[0] &&
                                                <AnchorLabelIcon typeaheadclass="m-checkoutHelp" href={rightLink3[0].url} labelclass="a-checkoutHelp__text -primaryColor" text=" Ayuda" iconclass="icon-help a-checkoutHelp__icon -primaryColor" />
                                ...
                                <div className="row align-items-end no-gutters justify-content-center pt-5">
                                    {nightBox !== undefined && !flag3DS? <Alerts options={warnings} /> : null}
                                    ...
                                    <div className="col-lg-5 col-6">
                                        <H5 headLineClass="a-checkout__nameHeading m-0 pb-2" headLineText={(deleveryAddressDetail && deleveryAddressDetail.firstName ? deleveryAddressDetail.firstName : '') + ' ' + (deleveryAddressDetail && deleveryAddressDetail.lastName ? deleveryAddressDetail.lastName : '')} />
                                        ...
                                        <Paragraph className="a-checkout__headingFace m-0 pb-2">{!paymentFlag ?staticLabels && staticLabels['pwa.orderConfirmationPage.thanksMsg1.text']?staticLabels['pwa.orderConfirmationPage.thanksMsg1.text']: 'Gracias por tu pedido':'Gracias por tu pedido'}</Paragraph>
                                ...
                                <div className="row align-items-center justify-content-center pt-3 ">
                                    <div className="col-12 text-lg-center text-left">
                                        <ParagraphSpanX4
                                            ...
                                            span1Text={ paymentFlag ? "Recibirás en breve un mail con el resumen de tu Pedido a:" :"Recibirás en breve un mail con el resumen de tu compra a:"}
...

                        {
                            (paymentDetail && paymentDetail['Forma de pago'] && paymentDetail['Forma de pago'].trim().toLowerCase() === 'Transferencia'.toLowerCase())
                                ...
                                ?
                                <div className="row align-items-center justify-content-center pt-3 pb-5" style={{paddingTop: '3rem!important'}}>
