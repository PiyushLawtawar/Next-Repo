...
const Snb = require('../controllers/snb');
const Cnc = require('../controllers/cnc');
const Account = require('../controllers/account');
const Wishlist = require('../controllers/wishlist');
const staticFile = require('../controllers/staticFiles');
module.exports = function (app) {
    return [
        ...
        },
        {
            method: 'GET',
            //path: '/getvariants',
            path: '/tienda/browse/getVariantDetails',
            handler: function (req, reply) {
        ...
        {
            method: 'GET',
            path: '/tienda/browse/getCarouselHome',
            handler: function (req, reply) {
                return Snb.getCarousels(req, reply, app);
            },
            config: {
        ...
        },
        {
            ...
            handler: function (req, reply) {
                return Snb.recentlyViewed(req, reply, app);
            },
            config: {
                state: {
                    parse: false, // parse and store in request.state
        ...
        {
            method: 'GET',  // getTypeheadData service convert to GET from POST
        ...
        },
        {
            ...
            handler: function (req, reply) {
                ...
                return Snb.homePageNewApproach(req,reply,app);
            },
            config: {
                state: {
                    parse: false, // parse and store in request.state
        ...
        {
            method: 'GET',
            path: '/tienda/users/createInvoice',
            handler: function (req, reply) {
                return Account.getHeaderDetails(req, reply, app);
            },
            config: {
        ...
        {
            method: 'GET',
            path: '/tienda/users/invoiceRequest',
            handler: function (req, reply) {
                return Account.getHeaderDetails(req, reply, app);
            },
            config: {
        ...
        {
            method: 'GET',
            path: '/tienda/users/invoiceConfirmation',
        ...
        //get Static Promotions
        {
            ...
            handler: function (req, reply) {
                return Snb.getHeader(req, reply, app);
            },
            config: {
                state: {
                    parse: false, // parse and store in request.state
        ...
        {
            method: 'GET',
            path: '/tienda/oneColumnPage/:pdpName/:productName/:productId/:pdpTypeForSPA',
            handler: defaultHandlerWrapper(app),
           /*  handler: function (req, reply) {
        ...
        {
            method: 'GET', // oneColumnPageData Call POST to GET
            path: '/tienda/oneColumnPageData',
            handler: function (req, reply) {
                let a = req.query || {};
                return Snb.getPdpData(req, reply, app);
            },
            config: {
                state: {
                    parse: false, // parse and store in request.state
        ...
        // {
        //     method: 'GET',
        //     path: '/tienda/CollectionSPA/:pdpName/:productName/:productId',
        //     handler: defaultHandlerWrapper(app),
        //    /*  handler: function (req, reply) {
        //         return Snb.pdpLandingPage(req, reply, app, 'default');
        //     }, */
        ...
        {
            method: 'GET',
            path: '/tienda/collectionSPAData',
            handler: function (req, reply) {
                //let a = req.query || {};
                //console.log("query data coll praveen", a);

                return Snb.getGroupCollectionData(req, reply, app);
            },
            config: {
                state: {
                    parse: false, // parse and store in request.state
        ...
        },
        {
            ...
            path: '/tienda/browse/getListOfStates',
            handler: function (req, reply) {
...

        {
            method: 'GET',
            // path: '/alloffers',
            path: '/tienda/browse/marketplace/products/allOffers',
            handler: function (req, reply) {
        ...
        },
        {
            method: 'GET',
            // path: '/offers',
            path: '/tienda/browse/marketplace/skus/offersListing',
            handler: function (req, reply) {
        ...
        {
            method: 'GET', // service addresssearch change GET from POST method  
            path: '/addresssearch',
            handler: function (req, reply, app) {
        ...
        },
        {
         ...
         { 
            method: 'GET',
            path: '/displaywishlistdetails',
            handler: function (req, reply) {
                return Cnc.displaywishlistdetails(req, reply, app, true);
            },
            config: {
                state: {
                    parse: false, // parse and store in request.state
        ...
        },
        {
            ...
            handler: function (req, reply) {
                return Cnc.getMyBagNewApproach(req, reply, app, true);
            },
            config: {
                state: {
                    parse: false, // parse and store in request.state
...

        {
            ...
            path: '/tienda/cart',
            handler: function (req, reply) {
                return Cnc.getMyBagNewApproach(req, reply, app);
            },
            config: {
                state: {
                    parse: false, // parse and store in request.state
        ...
        {
            method: 'POST',
            path: '/getRealTimeStock',
            handler: function (req, reply) {
                return Snb.getRealTimeStock(req, reply, app);
            },
            config: {
                state: {
                    parse: false, // parse and store in request.state
        ...
        },
        {
            ...
            path: '/grgiftmessage',
            handler: function (req, reply) {
                return Cnc.setGrGiftMessage(req, reply, app);
            },
            config: {
                state: {
                    parse: false, // parse and store in request.state
        ...
        {
            method: 'GET',
            path: '/tienda/checkoutOrderConfirmationAirTime',
            handler: function (req, reply) {
                // return Cnc.checkoutBillingPage(req, reply, app, 'checkoutbillingpage', false);
                return Cnc.checkoutstep4(req, reply, app);
            },
        ...
        {
            method: 'GET',
            path: '/staticLabelsFetch',
            handler: function (req, reply) {
                return Cnc.getStaticLabelsFetch(req, reply, app);
        ...
        },
        {
            ...
            path: '/404wlm',
            handler: function (req, reply) {
                return reply.file(__dirname + '/../static/404wlm.html');
            },
            config: {
                state: {
                    parse: false, // parse and store in request.state
        ...
        },
        {
            ...
            path: '/evaluation',
            handler: function (req, reply) {
                return Account.evaluation(req, reply, app);
            },
            config: {
                state: {
                    parse: false, // parse and store in request.state
        ...
        {
            method: 'POST',
            path: '/validateUpdateProfile',
            handler: function (req, reply) {
                return Account.validateUpdateProfile(req, reply, app);
            },
            config: {
                state: {
                    parse: false, // parse and store in request.state
        ...
        {
            method: 'POST',
            path: '/addpdpitemtocart',
            handler: function (req, reply) {
                return Snb.addToBagPdp(req, reply, app);
            },
            config: {
                state: {
                    parse: false, // parse and store in request.state
        ...
        {
            method: 'POST',
            path: '/addItemToCartFromWishlist',
            handler: function (req, reply) {
                return Cnc.addToBag(req, reply, app);
            },
            config: {
        ...
        },
        {
            ...
            handler: function (req, reply) {
                return Snb.invalidateCache(req, reply, app);
            },
            config: {
                state: {
                    parse: false, // parse and store in request.state
